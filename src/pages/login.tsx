  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-r from-indigo-50 via-white to-indigo-100 px-4">
      ...
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-sm">
        <h1 className="text-3xl font-bold text-center text-indigo-700 mb-6">Login to FinDocAI</h1>
        ...
        <p className="mt-4 text-center text-sm text-gray-500">
          ...
          <span className="text-indigo-600 underline cursor-pointer" onClick={() => router.push('/register')}>
            Sign up
          </span>
        </p>
      </div>
...
Login.getLayout = function PageLayout(page: React.ReactNode) {
  return <>{page}</>; // This disables layout for login
};
